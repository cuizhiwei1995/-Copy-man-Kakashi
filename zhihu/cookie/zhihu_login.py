...
#timestamp要变换。captcha= 要变换 signature=要变换
class ZhihuAccount(object):
    ...
    def __init__(self, username: str = None, password: str = None):
        ...
        self. login_data = {
            ...
            'password': '',
            'lang': 'en',
            'ref_source': 'other_https%3A%2F%2Fwww.zhihu.com%2Fsignin%3Fnext%3D%252Fhot"encodeURIComponent',
            'utm_source': ''
        }
    ...
    def login(self, captcha_lang: str = 'cn', load_cookies: bool = True):
        """
        模拟登录知乎
    ...
    def _encrypt(form_data: dict):
            with open('./encrypt.js') as f:
                ...
                print(js.call('Q', urlencode(form_data)))
                return js.call('Q', urlencode(form_data))


if __name__ == '__main__':
    account = ZhihuAccount('18061738850', 'czw1995happy')
